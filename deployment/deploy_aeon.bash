...
cd ~
git clone https://github.com/ArqTras/aeon-rebase-pool.git  # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
bash ~/aeon-rebase-pool/deployment/install_lmdb_tools.sh
cd ~/aeon-rebase-pool/sql_sync/
